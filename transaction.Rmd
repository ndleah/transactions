...
* `mean_monthly ~ date + month_number`

* `mean_monthly ~ date + month_number + year_number`

We need to enhance the model’s complexity to overcome under-fitting

* `mean_monthly ~ date + month_number * sin(2piyear)`
